	...
	public static void main(String args[]) throws Exception {
		try {
			...
			if (vwSession != null) {
				...
				Date endd = new Date();
				System.out.println("Itr Elapsed for Log Fetch: "
						...
						if (op.getName().toString().equals(entry.getValue().get("F_Class").toString())) { // added this for the step name
							for (ProcessEngineObject obj : op.getSteps()) {
								if (entry.getValue().get("StepName").toString().equals(obj.getName())
									...
									String ddate = "";
									double stepRen = Utilities.accumMinRen(entry.getValue().get("F_WobNum").toString(),
											entry.getValue().get("StepName").toString(), logdata, holdaylist);
